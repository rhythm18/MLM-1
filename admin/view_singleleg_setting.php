...
<html lang="en">
  ...
  <head>
    ...
    <title>Manage Single Leg Settings</title>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i >Manage Single Leg Settings</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Manage Single Leg Settings</li>

          <li class="breadcrumb-item"><a href="add_singleleg_setting.php">Add Singleleg Setting</a></li>
