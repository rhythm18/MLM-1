...
<html lang="en">
  ...
  <head>
    ...
    <title>MLM Admin - dashboard</title>
...
{ 
  ...
  ?>
              ...
              <p><b><?php echo "<a href=showpendingkyc.php?".$row['pending_kycs'].'>'.$row['pending_kycs']."</a>";?></b></p>
...
<div class="col-md-6 col-lg-3">
      ...
      $sql="SELECT count(*) as pending_bank FROM `bank_detail` WHERE status=2";
...
{ 
  ...
  ?>
              ...
              <h4>Pending Bank Details</h4>

              <p><b><?php echo "<a href=showpendingbank.php?".$row['pending_bank'].'>'.$row['pending_bank']."</a>";?></b></p>
...
{ 
  ...
  ?>
              ...
              <p><b><?php echo "<a href=pay_detail.php?".$row['total_joining_fee'].'>'."Rs.".$row['total_joining_fee']."</a>";?></b></p>
