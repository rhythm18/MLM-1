...
?></a>
	...
	?>
     <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Update Generation Income Setting</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Update Generation Income Setting</li>
        </ul>
      </div>
      <div class="row">
       <div class="col-md-12">
...
if(isset($_POST['submit']))
{
  ...
  if(mysqli_query($conn,$sql))
  {
   ...
   echo "<b>Generation Income level Info Updated !!</b>";
