...
$memberID=$rows['member_id'];
  ...
  echo "<td>".$payStatus."</td>";
	  ...
	  echo "<td>"."<a href=user_delete.php?userID=".$row['user_id']."><img src=delete.png width=25 height=25></a></a>".  "<a href=edituserdetail.php?userID=".$row['user_id']."><img src=edit.png width=25 height=25></a>"."</td>";
