...
if(isset($_POST['submit']))
{
 ...
 $sql="update admin set number='$number',name='$name' where admin_id=$id";
...
<div class="form-group row">
    <label for="number" class="control-label col-md-3">Contact Number:  </label>
        <div class="col-md-8">
    <input name="number" type="number" class="form-control" id="number" value="<?php echo $row['number'];?>" required>
  </div>
</div>
