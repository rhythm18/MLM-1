     ...
     <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i>Income Settings</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Income Settings</li>
...
<div class="form-group row">
    ...
    <select class="form-control" name="rank_income" id="rank_income" >
      ...
      { ?>
      <option value="1" selected>All rank income</option>

      <option value="2">Highest rank income</option>
      <?php }  if ($row['rank_income']==2)  { ?>

       <option value="1" >All rank income</option>

      <option value="2" selected>Highest rank income</option>
