...
//payout  direct income/generation income
  ...
  if($errorFlag==0)
  	{
  		...
  		@mail("pcsaini@gmail.com", "dhanyog Payout Success", "Payout Generated Successfully");
	}

else
{
	  @mail("pcsaini@gmail.com", "dhanyog Payout Error", "There was an error in Payout Generation");
