    ...
    <main class="app-content">
      ...
      <div class="app-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-edit"></i >Manage Generation Income Settings</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Manage Generation Income Settings</li>

          <li class="breadcrumb-item"><a href="add_gen_income_setting.php">Add Generation Income Setting</a></li>
