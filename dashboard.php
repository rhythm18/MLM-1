...
<html lang="en">
  ...
  <head>
    ...
    <title>Dhanyog User - Dashboard</title>
...
?>
      ...
      <div class="row">
       ...
       <div class="col-md-6 col-lg-3">
                    ...
                    <div class="widget-small warning coloured-icon" style="background-color:#a1ff00;"><i class="icon fa fa-files-o fa-3x"></i>
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <div class="widget-small warning coloured-icon" style="background-color:#ffc0be;"><i class="icon fa fa-files-o fa-3x"></i>
      ...
      <?php
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <div class="widget-small warning coloured-icon" style="background-color:#a1a9e6;"><i class="icon fa fa-files-o fa-3x"></i>
...
<?php
   ...
   $sql="SELECT COUNT(*) from users where pay_status=1 and activation_date>='$activateDate' and user_id>".$_SESSION['user_id'];



        $countMyTeam=ReturnAnyValue($conn,$sql);
        ...
        <h4>My Team:</h4>
                      ...
                      <p><b><?php echo "<a href=my_team.php>".$countMyTeam."</a>";?></b></p>
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <div class="widget-small info coloured-icon" style="background-color: #79ffda"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
...
<?php
        ...
        $sql="SELECT COUNT(*) from users where pay_status=1 and sponsor_id=".$_SESSION['user_id'];
        ...
        <h4>My Sponsors:</h4>
          ...
          <div class="widget-small info coloured-icon" style="background-color:#ffa500;"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
...
if($countMyTeam>=$row['member_count'] && $countMySponsored>=$row['dir_req'])
...

{
  ...
  $strStyle="";
    ...
    echo "<td>".$row['lvl_income']*$row['days']."</td>";
