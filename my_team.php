...
$sql="select activation_date from users where user_id=".$uid;
$activationDate=ReturnAnyValue($conn,$sql);




$sql="select * from users where pay_status=1 and activation_date>='$activationDate' and user_id>".$uid;
